...
const projects = [
  {
    title: "Zoom Clone",
    description: "A video conferencing platform built with React and WebRTC that allows users to join meetings and communicate in real-time.",
    image: "https://i.ibb.co/8LkcXTQs/connectrtc-portfolio-cover.png",
    tech: ["React", "WebRTC", "Node.js"],
    github: "https://github.com/Daniels-not/clientzoomer",
    live: "https://jocular-gumdrop-f3efff.netlify.app/",
    number: "01",
  },
  {
    title: "Oakwood Campus Map",
    description: "Platform for Oakwood University with maps, faculty info, and real-time updates.",
  ...
  },
  {
    ...
    description: "AI-driven stock price prediction tool with real-time data and visualization.",
    image: "https://i.ibb.co/gbxL6nX0/index-Streamlit-1.png",
    tech: ["Python", "Pandas", "Streamlit"],
    github: "https://github.com/Daniels-not/StockPrediction",
    live: "https://github.com/Daniels-not/StockPrediction",
    number: "03",
  },
  {
    title: "ReceiptIQ",
  ...
  {
    title: "Elite Visual Studio",
    description: "A creative agency site for a company specializing in stunning visual content for advertising, entertainment, and gaming.",
    image: "https://i.ibb.co/8YL07vf/hero.png",
    tech: ["React", "Tailwind CSS", "GSAP"],
    github: "https://github.com/Daniels-not/EliteVisualStudio",
